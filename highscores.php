...
<?php 
	...
	$AllAcounts = $bdd->prepare("SELECT Player_Name, account FROM players ORDER BY account DESC LIMIT 10");
	$AllAcounts->execute(); 
...
?>
	...
	<div id='highscores'>
		<div class='players'>
			<div id="column_Title">
				<h2>Top 10</h2><h2><?php echo $TotalAmount; ?>
			...
			<?php
				...
				while ($highscore = $AllAcounts->fetch()) {
					...
					echo '<p>' . $highscore[0] . '</p>';
					echo '<p>' . $highscore[1] . '</p>';
					echo '</div>';
				} 
			?>
